...
const s = {
  app: { fontFamily: "'DM Sans', sans-serif", maxWidth: '100%', margin: '0 auto', minHeight: '100vh', background: '#050f05', color: '#e8f0e8', paddingBottom: '40px', position: 'relative', overflowX: 'hidden' },
